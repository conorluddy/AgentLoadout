...
const presets = [
  ...
  },
  {
    ...
    count: 20,
    default: true,
    description: "Tools that make AI agents genuinely more capable. AST-level search, static analysis, benchmarking, load testing, link checking, prose linting, and structured code operations.",
    tools: ["shellcheck", "ast-grep", "just", "grex", "knip", "sd", "hyperfine", "tokei", "tldr", "biome", "difftastic", "pandoc", "duckdb", "htmlq", "typos", "gum", "oha", "gron", "lychee", "vale"],
  },
  {
    id: "media",
    title: "Media",
    count: 4,
    default: false,
    description: "Audio, video, and image processing pipelines. ffmpeg, exiftool, ImageMagick, and libvips for heavy-duty media work.",
    tools: ["ffmpeg", "exiftool", "imagemagick", "vips"],
  },
  {
    id: "design",
    title: "Design",
    count: 7,
    default: false,
    description: "Visual asset workflows. SVG optimization and rendering, colour palettes, diagramming, and PNG compression.",
    tools: ["svgo", "resvg", "chafa", "pastel", "d2", "pngquant", "oxipng"],
  },
  {
    id: "dx",
    title: "DX",
    count: 18,
    default: false,
    description: "Developer experience tools. Modern replacements for ls, cd, ps, du, and git diff. Runtime management, file watching, local HTTPS, and terminal recording.",
    tools: ["eza", "zoxide", "delta", "glow", "mise", "watchexec", "mkcert", "lazygit", "dust", "bottom", "direnv", "procs", "uv", "hexyl", "taplo", "fx", "csview", "asciinema"],
  },
  {
    id: "security",
    title: "Security",
